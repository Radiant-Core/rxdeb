/* config/bitcoin-config.h.  Generated from bitcoin-config.h.in by configure.  */
/* config/bitcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Radiant Blockchain developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Radiant Blockchain"

/* Copyright year */
#define COPYRIGHT_YEAR 2026

/* Define to 1 to enable dangerous features */
/* #undef ENABLE_DANGEROUS */
...
#define PACKAGE_BUGREPORT "https://github.com/radiantblockchain/rxdeb/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Radiant Script Debugger"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Radiant Script Debugger 5.0.24"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "rxdeb"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://radiantblockchain.org"

/* Define to the version of this package. */
#define PACKAGE_VERSION "5.0.24"

/* Define to 1 to enable Radiant support */
#define RXD_SUPPORT 1
